...
silent only
cd ~/590-material/lecture/11-recursive-enum/01_cons
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +26 src/main.rs
badd +0 src/dot_gen.rs
argglobal
silent! argdel *
$argadd src/main.rs
edit src/main.rs
...
silent! normal! zE
let s:l = 19 - ((16 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
normal! 0
lcd ~/590-material/lecture/11-recursive-enum/01_cons
wincmd w
argglobal
if bufexists('~/590-material/lecture/11-recursive-enum/01_cons/src/dot_gen.rs') | buffer ~/590-material/lecture/11-recursive-enum/01_cons/src/dot_gen.rs | else | edit ~/590-material/lecture/11-recursive-enum/01_cons/src/dot_gen.rs | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>GitGutterPrevHunk
onoremap <buffer> <silent> [[ :call rust#Jump('o', 'Back')
